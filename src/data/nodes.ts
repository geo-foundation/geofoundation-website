...
/*
  1) German Automotive Company
     ...
     - Disruptions: Energy crisis (North Stream Two blow) and Economic downturn in Japan
*/
export const nodes: BusinessNode[] = [
  ...
  /*
    2) Silicon Valley Tech Company
       ...
       - Disruptions: Missing chips (chip supply shortage) and political policy changes (uncertainty from new administration)
  */
  {
    id: 'sv_tech_hq',
